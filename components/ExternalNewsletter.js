      ...
      <div className="flex flex-col md:flex-row">
        <div className="md:w-[70%] p-8 flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <motion.button
              className="bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-full flex items-center justify-center transition-colors"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={handleExternalLink}
            >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent flex flex-col justify-end p-6">
              <div className="text-white">
                <p className="mb-2 text-sm font-medium bg-blue-600 w-fit px-2 py-1 rounded-full">
                  {edition}
                </p>
                <h3 className="text-2xl font-bold mb-2">{publishDate}</h3>
