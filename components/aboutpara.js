...
export default function AboutPara() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      <h1 className="text-3xl md:text-4xl font-light mb-8 md:mb-12 text-center text-gray-800 tracking-[0.25em]">LEARN MORE</h1>
      ...
      <div className="mt-8 md:mt-12 bg-white p-4 md:p-6 rounded-lg shadow-sm">
        <h2 className="text-xl md:text-2xl font-light mb-4 md:mb-6 text-center text-gray-700 tracking-[0.25em]">OUR VALUES</h2>
