...
export default function InterviewPage() {
    ...
    const uploadAudio = async (interviewId, responseId, audioBlob) => {
        try {
            ...
            const response = await fetch(
                `${API_BASE_URL}/interviews/${interviewId}/responses/${responseId}/audio/`,
                {
                    method: "POST",
                    body: formData,
                },
    ...
    const handleNextQuestion = async () => {
        ...
        const respId = await createResponse(interviewId, questions[currentQuestionIndex].id, transcript)
                ...
                return (
                    <div className="text-center">
                        <div className="mb-8 relative">
                            <svg className="w-16 h-16 mx-auto text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <h2 className="text-red-600 text-3xl font-bold mb-6">AI-Powered Voice Interview</h2>
                        ...
                        <p className="mb-4 leading-relaxed text-lg">
                            You'll be able to answer verbally, and your responses will be recorded and transcribed automatically.
                        </p>
                        <p className="mb-4 leading-relaxed text-lg">
                        ...
                        <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-xl shadow-lg my-8 text-left border border-gray-200">
                            ...
                            <ol className="list-decimal pl-6 space-y-3">
                                <li className="text-gray-700">Make sure you're in a quiet environment</li>
                                <li className="text-gray-700">Allow microphone access when prompted</li>
                                <li className="text-gray-700">Listen to each question carefully</li>
                                <li className="text-gray-700">Speak clearly when answering</li>
                                <li className="text-gray-700">Click "Stop Recording" when you've finished your answer</li>
                            </ol>
                        </div>
                        <button
                        ...
                        <div className="mb-6">
                            <div className="flex items-start">
                                ...
                                <div className="w-full">
                                    ...
                                    <div className={`min-h-[150px] border border-gray-300 rounded-lg p-5 mb-4 ${isRecording ? 'bg-red-50 border-red-200' : 'bg-white'} transition-colors duration-200 whitespace-pre-wrap shadow-inner`}>
                                        {transcript || (
                                    ...
                                    {!profileInfo.resume ? (
                                        ...
                                        <div className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
                                            <div className="flex items-center">
                                                <svg className="w-8 h-8 text-red-600 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="my-8 p-6 bg-gray-50 rounded-lg border border-gray-200 text-left">
                            ...
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-start">
                                    <svg className="w-5 h-5 text-green-500 mr-2 mt-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="max-w-3xl mx-auto font-sans text-gray-800 relative">
                {error && (
                    <div className="bg-red-50 border-l-4 border-red-600 p-4 mb-6 rounded-r-lg shadow-md flex justify-between items-center">
                        <div className="flex items-center">
                            <svg className="w-6 h-6 text-red-600 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="mt-12 text-center text-gray-500 text-sm">
                    <p>© {new Date().getFullYear()} Powered by AI Interview System</p>
                </div>
            </div>
        </div>
    )
