...
const InkAndInsightsPage = () => {
    ...
    const authors = [
        { image: '/images/spmittson.JPG', name: 'S.P. Mittson', bio: 'S.P. Mittson is a remarkable figure who has successfully transitioned from a career as a Chartered Accountant (CA) to becoming an acclaimed author. Her journey from the corporate world of finance to the realm of literature is truly inspiring, demonstrating her versatility and passion for storytelling. Her debut novel, The Wandering Star, has quickly gained widespread attention and is now an Amazon Best Seller, a testament to her skill in weaving captivating narratives that resonate deeply with readers.Despite her background in finance, S.P. Mittson’s literary talent has allowed her to make a significant mark in the publishing world. Her ability to create rich, immersive stories filled with emotion and depth has garnered her a dedicated readership. Currently, she is working with one of India’s top publishing houses, which further solidifies her status as an emerging literary talent in the country. Her unique perspective, shaped by her experience as a CA, gives her stories a distinctive edge, blending precision with creativity. With her growing reputation and the success of her debut, S.P. Mittson is undoubtedly a rising star in contemporary Indian literature, and readers eagerly await her future works.' },
        { image: '/images/pranaybhalerao.JPG', name: 'Pranay Bhalerao', bio: 'Pranay Bhalerao is a distinguished author and a rising star in the literary world, known for his captivating storytelling and gripping narratives. He is the author of the Amazon Best Seller The Lost World Trilogy, a series that gained widespread acclaim for its immersive world-building and intricate plots. Building on this success, Pranay is currently working on the second book of the Kavaach Trilogy, which has already become a best-selling series, captivating readers with its thrilling storyline and complex characters.   In addition to his accomplishments as an author, Pranay also works at T-Systems, a global leader in IT services and consulting. His ability to balance a successful career in the corporate world while excelling in his creative pursuits has earned him numerous accolades, including awards for his literary work. With a unique blend of creativity and technical expertise, Pranay continues to inspire and captivate readers worldwide. ' },
        { image: '/images/tanishatiwari.JPG', name: 'Tanisha Tiwari', bio: 'Tanisha Tiwari is a highly acclaimed, award-winning author with a powerful voice in contemporary literature. Her debut book quickly rose to the top, becoming an Amazon Best Seller, a testament to her ability to connect with readers through her engaging writing and thought-provoking themes. Beyond her success as an author, Tanisha has an impressive professional background, having worked with The Times of India, one of the country’s leading news organizations, where she demonstrated her skills in journalism and content creation.   Tanisha also played a significant role in heading content for the G20 Global Summit, showcasing her leadership and expertise in handling high-stakes global events. She is currently working on her next book, which is eagerly anticipated and set to be published by one of the biggest names in the publishing industry. With her growing reputation in both the literary and media worlds, Tanisha Tiwari continues to make a significant impact with her insightful and compelling work.' },
    ];
